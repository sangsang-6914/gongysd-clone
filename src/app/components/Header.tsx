    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <button
            type="button"
            className="rounded-full border border-primary bg-primary px-5 py-2 text-sm font-medium text-background transition-all hover:bg-background hover:text-primary"
          >
            로그인
          </button>
        </div>
      ...
      {mobileOpen && (
        <nav className="flex flex-col gap-4 border-t border-border bg-background px-6 py-6 md:hidden">
          ...
          <button
            type="button"
            className="mt-2 w-full rounded-full bg-primary py-2.5 text-sm font-medium text-background"
          >
            로그인
          </button>
        </nav>
